...
class CryptoCurrencyControllerTest {
    ...
    void testCreateCryptoNullCryptoName() throws Exception{
        ...
        given(cryptoCurrencyService.saveNewCryptoCurrency(any(CryptoCurrencyDTO.class))).willReturn(cryptoCurrencyServiceImpl.listCryptoCurrencies(null, false, 1, 25).get(1));
    ...
    void testPatchCrypto() throws Exception {
        CryptoCurrencyDTO cryptoCurrency = cryptoCurrencyServiceImpl.listCryptoCurrencies(null, false, 1, 25).get(0);
    ...
    void isValidObject() throws Exception {
        CryptoCurrencyDTO testCrypto = cryptoCurrencyServiceImpl.listCryptoCurrencies(null, false, 1, 25).get(0);
