...
class CryptoCurrencyControllerTest {
    ...
    void testCreateCryptoNullCryptoName() throws Exception{
        ...
        given(cryptoCurrencyService.saveNewCryptoCurrency(any(CryptoCurrencyDTO.class))).willReturn(cryptoCurrencyServiceImpl.listCryptoCurrencies(null, false, 1, 25).getContent().get(0));
    ...
    void testPatchCrypto() throws Exception {
        CryptoCurrencyDTO cryptoCurrency = cryptoCurrencyServiceImpl.listCryptoCurrencies(null, false, 1, 25).getContent().get(0);
    ...
    void testCreateNewCrypto() throws Exception {
        ...
        given(cryptoCurrencyService.saveNewCryptoCurrency(any(CryptoCurrencyDTO.class))).willReturn(cryptoCurrencyServiceImpl.listCryptoCurrencies(null, false, 1, 25).getContent().get(1));
    ...
    void testListCrypto() throws Exception {
        given(cryptoCurrencyService.listCryptoCurrencies(any(), any(), any(), any()))
                .willReturn(cryptoCurrencyServiceImpl.listCryptoCurrencies(null, false, 1, 25));
    ...
    void isValidObject() throws Exception {
        CryptoCurrencyDTO testCrypto = cryptoCurrencyServiceImpl.listCryptoCurrencies(null, false, 1, 25).getContent().get(0);
